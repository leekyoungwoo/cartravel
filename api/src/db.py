...
def init_query_dict():
    for file in [
        file for file in os.listdir(
            os.path.join(
            GLOBAL_CONFIG.CARTRAVEL_ROOT_DIR,
            'query')) if file.endswith(".yaml")]:
        with open(os.path.join(GLOBAL_CONFIG.CARTRAVEL_ROOT_DIR, 'query', file), encoding='utf8') as stream:
            try:
...
_AUTH_DICT = {
    'access_group': {
        'system_table': 'user_group',
        'system_column': {
            'no': 'ug_no',
            'system': 'ug_system',
            'creator': 'ug_creator_no'
        },
        'target_no': 'acg_no',
        'auth_table': 'access_group_auth',
        'level_no': 'acga_level',
        'link_table': 'user_access_group_link',
        'link_no': 'ug_no'
    },
    'asset_group': {
        'system_table': 'access_group',
        'system_column': {
            'no': 'acg_no',
            'system': 'acg_system',
            'creator': 'acg_creator_no'
        },
        'target_no': 'ag_no',
        'auth_table': 'asset_group_auth',
        'level_no': 'aga_level',
        'link_table': 'asset_access_group_link',
        'link_no': 'acg_no'
    },
    'asset': {
        'system_table': 'asset_group',
        'system_column': {
            'no': 'ag_no',
            'system': 'ag_system',
            'creator': 'ag_creator_no'
        },
        'target_no': 'ai_no',
        'auth_table': 'asset_auth',
        'level_no': 'aa_level',
        'link_table': 'asset_group_link',
        'link_no': 'ag_no'
    }
}
